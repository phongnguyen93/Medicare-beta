package com.namlongsolutions.medicare.maps;
...
import com.namlongsolutions.medicare.extras.Utils;
import com.namlongsolutions.medicare.fragments.MapFragments;
import com.namlongsolutions.medicare.thread.network_thread.JSONArrayRequest;
import com.namlongsolutions.medicare.extras.JSONParse;
...
public class MapOperations extends MapFragments implements ClusterManager.OnClusterClickListener<Doctor>, ClusterManager.OnClusterInfoWindowClickListener<Doctor>, ClusterManager.OnClusterItemClickListener<Doctor>, ClusterManager.OnClusterItemInfoWindowClickListener<Doctor>,JSONArrayRequest.AsyncResponse {
    ...
    private void connection() {
        ...
        String request = "http://medicare1-phongtest.rhcloud.com/rest_web_service/service/getalldoctor?limit=100";
