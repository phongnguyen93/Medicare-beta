...
import com.namlongsolutions.medicare.ui_view.dateslider.timeview.mTimeTextView;
...
public abstract class Labeler {
     ...
     *
     * @param context
     * @param isCenterView is true when theCalendarCellView.java
    CalendarCellDecorator.java
    CalendarGridView.java
    CalendarRowView.java
    CalendarPickerView.java
    Logr.java
    MonthCellDescriptor.java
    MonthDescriptor.java
    MonthView.java view is the central view
     * @return The new unpopulated TimeView object
     */
    public TimeView createView(Context context, boolean isCenterView) {
        return new mTimeTextView(context, isCenterView, 15);
    }
