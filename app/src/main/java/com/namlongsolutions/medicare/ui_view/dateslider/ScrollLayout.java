...
import com.namlongsolutions.medicare.ui_view.dateslider.labeler.Labeler;
import com.namlongsolutions.medicare.ui_view.dateslider.timeview.TimeView;
...
public class ScrollLayout extends LinearLayout {
    ...
    public ScrollLayout(Context context, AttributeSet attrs) {
        ...
        rightShadow = getContext().getResources().getDrawable(R.drawable.ic_chevron_right_black_24dp);
        leftShadow = getContext().getResources().getDrawable(R.drawable.ic_chevron_left_black_24dp);
