package com.namlongsolutions.medicare.ui_view.dateslider.timeview;
...
import com.namlongsolutions.medicare.ui_view.dateslider.TimeObject;
 ...
 */
public class mTimeTextView extends TextView implements TimeView {
     ...
     */
    public mTimeTextView(Context context, boolean isCenterView, int textSize) {
        super(context);
