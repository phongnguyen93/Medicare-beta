...
import com.namlongsolutions.medicare.database.DbHelper.tableBooking;
import com.namlongsolutions.medicare.database.DbHelper.tableDoctor;
import com.namlongsolutions.medicare.database.DbHelper.tableSession;
import com.namlongsolutions.medicare.database.DbHelper.tableUser;
...
public class DbOperations extends SQLiteOpenHelper {
    ...
    public boolean putUser(DbOperations dop, String id, String name, String phone, String email) {
        SQLiteDatabase SQ = dop.getWritableDatabase();
        ContentValues cv = new ContentValues();
