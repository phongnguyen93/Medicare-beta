 ...
 *
 */
public class SignupActivity extends BaseActivity implements Button.OnClickListener, UserFunctions.SetCurrentUserResult{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        viewHolder();
        userFunctions = new UserFunctions(getApplicationContext(),this);
    }
    ...
    private void validateSignUp(JSONObject jsonObject) {
        try {
            ...
            if(status) {
                ...
                userFunctions.setCurrentUser(id, pass);
