 ...
 */
public class FavDoctorFunctions implements FavDoctor, JSONArrayRequest.AsyncResponse,JSONObjectRequest.AsyncResponse {
    ...
    public FavDoctorFunctions(Context context){
